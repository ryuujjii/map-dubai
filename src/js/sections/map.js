...
export function map() {
  ...
  let darkMap = "https://d3b6muno9lbfvx.cloudfront.net/project-map/img/map/road_8k.jpg"
  let lightMap = "https://d3b6muno9lbfvx.cloudfront.net/project-map/img/map/123.png"
